...
class ProductImage(models.Model):
    ...
    product_tmpl_id = fields.Many2one("product.template", string="Product Template", index=True, ondelete="cascade")
    product_variant_id = fields.Many2one("product.product", string="Product Variant", index=True, ondelete="cascade")
